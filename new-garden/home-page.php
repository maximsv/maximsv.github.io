...
<section class="content">
	...
	// Start the loop.
				while ( have_posts() ) : the_post(); ?>
					...
					<h2><img class="sprout-decor" src="<?php bloginfo('template_url');?>/img/sprout.png" alt="Питомник саженцев в Умани"> Продажа растений</h2>
						<?php the_content(); ?>
					</div>
				<?php endwhile; ?>
...
<div class="row">
						...
						<div class="col-md-4 col-sm-6 thumbnail-wrapper">
							<?php if ( is_active_sidebar( 'card-2' ) ) : ?>
								...
								<div id="card-2" class="Fruit_trees">
